...
/**
 * @brief A matrix polynomial used to detail lattices in the scheme.
 * @param rows The number of rows in the matrix.
 * @param cols The number of columns in the matrix.
 * @param data The backing data for the matrix.
 * @param isNTT Whether the matrix has been tranformed to support NTT operations.
 *
 * @details
 * RLWE utilises a polynomial matrix over a scalar matrix.
 *
 * @def operator[] Access the data of the matrix.
 * @def operator= Copy the data of another matrix into this one.
*/
struct MatPoly {
    size_t rows;
    size_t cols;
